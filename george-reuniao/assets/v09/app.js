...
function agendaReportIntent(text){
 ...
 const report=/\b(relatorio|pdf)\b/.test(n)&&/\b(gera|gerar|gere|monte|montar|crie|criar|compartilha|compartilhar|baixa|baixar|imprime|imprimir|exporta|exportar)\b/.test(n);
