...
try {
  ...
  if (!$codigo) { json_out(['ok'=>false, 'error'=>'codigo inválido']); }

  // Impede sobrescrita se já existir
  $metaPath = DOCS_DIR . '/' . $codigo . '.json';   
  if (file_exists($metaPath)) {
  json_out(['ok'=>false, 'duplicate'=>true, 'error'=>'DOCUMENTO JÁ CADASTRADO']);
  }
