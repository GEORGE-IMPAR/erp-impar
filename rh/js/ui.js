(function(global){
  ...
  UI.renderFinanceiro=data=>{
    ...
    $('financeiroAviso').textContent=`Cálculo: ${s.kmLitro.toLocaleString('pt-BR')} km/L • ${money(s.precoLitro)}/L • raio ${s.raio.toLocaleString('pt-BR')} m • obra confirmada após 40 min no raio. Cada KM pertence a somente uma categoria.`;
