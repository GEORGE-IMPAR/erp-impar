/* consulta_json_v3_beauty_brand_fixclose_loader_OS.js  (VERSÃO: loader preto + fetch fix + OS overrides)
...
;(function(){
  ...
  function injectCSS(){
    ...
    var css=[
      ...
      '.cj-head{display:flex;align-items:center;justify-content:space-between;padding:16px 20px;background:linear-gradient(90deg,#0A1A3A,#08142E);color:#fff}',
      ...
      '.cj-code{font-weight:800;color:#0A1A3A}',
      ...
      '.cj-card-head{display:flex;align-items:center;justify-content:space-between;background:linear-gradient(90deg,#08142E,#0A1A3A);color:#fff;padding:16px 20px}',
      '.cj-chip{display:inline-block;background:#08142E;color:#cbd5e1;border:1px solid #334155;padding:4px 12px;border-radius:999px;font-size:12px;margin-left:8px}',
      ...
      '.btn.ghost{background:#e2e8f0;color:#0A1A3A}',
      '.btn.primary{background:linear-gradient(90deg,#08142E,#0A1A3A);color:#fff}',
